...
function displayWhat(){
    ...
    <div id="product">
       ...
       <p>The cushioning of the bed's mattress to the colour of the walls in the hallway and the availability of charging points at an arm's length - every nook and corner of a Dream Dorm residence has been designed to reflect you and your current life stage.</p>
    </div>
    <div id="amenities">
       <div>
    ...
    <div>
        ...
        <p>We want your stay with us to stay with you forever. We want you to find your new best friend, your future business partner, your band or anyone else who can help you grow. Trust us, you'll look back at this time as the one that changed your life forever.</p>
    </div>
    <div id="technology">
       <div>
...
function displayHow(){
    ...
    <div>
        ...
        <div>
            <p>The buildings that become our residences come in different shapes and sizes. And aren't we glad about that? That way, we can retain their distinct architecture while infusing them with our design philosophy.</p>
        </div>
